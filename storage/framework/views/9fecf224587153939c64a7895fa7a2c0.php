            ...
            <form id="filterForm" method="GET" class="row g-3 align-items-end">
                <div class="col-md-4">
                    ...
                    <select class="form-select text-dark" name="incident_type" id="incidentType">
                        ...
                        <?php $__currentLoopData = ['Flood', 'Fire', 'Accident', 'Earthquake']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($type); ?>" <?php echo e(request('incident_type') == $type ? 'selected' : ''); ?>><?php echo e($type); ?></option>
                ...
                <div class="col-md-4">
                    ...
                    <input type="date" name="date_reported" id="dateReported" value="<?php echo e(request('date_reported')); ?>" class="form-control text-dark">
                </div>
                ...
                <div class="col-md-4 d-flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.completed.incidents')); ?>" class="btn btn-secondary mt-2 w-50">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-md-3">
                <div class="card shadow-sm rounded-4 border-0 bg-white bg-opacity-10 text-white text-center p-3 hover-scale">
                    <div class="card-body">
                        <i class="bi <?php echo e($icons[$index]); ?> fs-2 mb-2"></i>
                        <h4 class="fw-bold mb-1"><?php echo e($counts[$type]); ?></h4>
                        <p class="mb-0 fw-semibold"><?php echo e($type); ?></p>
                    </div>
                </div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <table class="table table-hover table-bordered align-middle text-white mb-0">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $summary; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr class="text-center">
                                <td class="fw-semibold"><?php echo e($row['incident_type']); ?></td>
                                <td><?php echo e($row['count']); ?></td>
                                <td><?php echo e($row['victims']); ?></td>
                                <td class="text-danger fw-bold"><?php echo e($row['deaths']); ?></td>
                                <td class="text-success fw-bold"><?php echo e($row['rescued']); ?></td>
                                <td>
                                    <?php echo e($row['last_resolved'] 
        ...
        <div id="incidentCards" class="row g-4">
            <?php $__currentLoopData = $incidents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="col-md-6 col-lg-4 incident-card">
                    <?php echo $__env->make('admin.partials.incident-card', ['incident' => $incident], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    searchInput.addEventListener('input', function() {
        ...
        if (!query) {
            ...
            fetch(`<?php echo e(route('admin.completed-incidents.all')); ?>`)
                .then(res => res.json())
        ...
        fetch(`<?php echo e(route('admin.completed-incidents.search')); ?>?q=${encodeURIComponent(query)}`)
            .then(res => res.json())
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\responde_v2\resources\views\admin\completed-incidents.blade.php ENDPATH**/ ?>