...
<head>
    ...
    <title>Admin Panel | Responde</title>
    ...
    <style>
        ...
        .navbar {
            ...
            background: rgba(33, 37, 41, 0.9) !important; /* Slightly transparent dark */
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="adminNavbar">
            <ul class="navbar-nav center-nav">
                ...
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.incidents')); ?>" class="nav-link">
                        <i class="bi bi-exclamation-triangle-fill"></i> Incident Reports
                    </a>
                </li>
                <li class="nav-item">
                    <a href="<?php echo e(route('admin.completed.incidents')); ?>" class="nav-link">
...
<script>
    async function checkNewIncidents() {
        try {
            const res = await fetch("<?php echo e(route('admin.notifications.fetch')); ?>");
            ...
            notifications.forEach(notif => {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed || result.isDismissed) {
                        fetch(`/admin/notifications/read/${notif.id}`, {
                            method: 'POST',
                            headers: {
    ...
    setInterval(checkNewIncidents, 10000);
...
<script>
    document.getElementById('logoutBtn').addEventListener('click', function (e) {
        ...
        Swal.fire({
            title: 'Are you sure?',
            text: "You’re about to log out of the admin panel.",
            icon: 'warning',
            showCancelButton: true,
...
<?php /**PATH C:\xampp\htdocs\responde_v2\resources\views\layouts\admin.blade.php ENDPATH**/ ?>