                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge 
                                        ...
                                        <?php elseif($user->role === 'responder'): ?> bg-primary 
                                        <?php else: ?> bg-secondary <?php endif; ?>
                                        px-3 py-2 rounded-pill">
                                        <i class="bi bi-person-badge me-1"></i><?php echo e(ucfirst($user->role)); ?>
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <button class="btn btn-sm btn-outline-primary me-1" 
                                                ...
                                                onclick="editUser(<?php echo e($user->id); ?>, '<?php echo e($user->name); ?>', '<?php echo e($user->username); ?>', '<?php echo e($user->email); ?>', '<?php echo e($user->role); ?>', '<?php echo e($user->phone_number ?? ''); ?>')">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\responde_v2\resources\views\admin\user-management.blade.php ENDPATH**/ ?>