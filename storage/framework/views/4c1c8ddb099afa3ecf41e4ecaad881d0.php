...
<script>
    ...
    document.getElementById('reportForm').addEventListener('submit', async e => {
        ...
        try {
            const res = await fetch(`${BASE_URL}<?php echo e(route('incident.store', [], false)); ?>`, {
                method: "POST",
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\responde_v2\resources\views\user\report.blade.php ENDPATH**/ ?>