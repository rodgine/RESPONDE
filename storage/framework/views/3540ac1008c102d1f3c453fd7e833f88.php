...
<script>
    ...
    form.addEventListener('submit', async e => {
        ...
        try {
            const res = await fetch(`<?php echo e(route('user.update', $user->id)); ?>`, {
                method: 'PUT',
                headers: {
...
<?php echo $__env->make('layouts.user', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\responde_v2\resources\views\user\edit.blade.php ENDPATH**/ ?>