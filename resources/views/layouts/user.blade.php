    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="responderNavbar">
            <ul class="navbar-nav center-nav">
                <li class="nav-item"><a href="{{ route('user.dashboard') }}" class="nav-link"><i class="bi bi-speedometer2"></i> Dashboard</a></li>
                <li class="nav-item"><a href="{{ route('user.report') }}" class="nav-link"><i class="bi bi-exclamation-triangle"></i> Report Incident</a></li>
                <li class="nav-item"><a href="{{ route('user.myreports') }}" class="nav-link"><i class="bi bi-file-earmark-text"></i> My Reports</a></li>
            </ul>
